...
import com.Nexsta.Scheduling.Jobs.PublishPostJob;
...
public class ContentSchedulingService {
    ...
    public void schedulePostPublishing(String postId,Instant scheduledAt) throws SchedulerException {
        ...
        // only send scheduled email if post is scheduler 24h ahead
     if(scheduledAt.isAfter(Instant.now().plus(24,ChronoUnit.HOURS))){
            ...
            String at =scheduledAt.minus(12, ChronoUnit.HOURS).truncatedTo(ChronoUnit.SECONDS).toString();
